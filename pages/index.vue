<template>
  <main>
    <ul>
      <div>+</div>
      <li v-for="(index, item) in 20" :key="index">
        <img src="https://loremflickr.com/150/150" alt="">
        <h2>Brusko</h2>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure, ipsa?</p>
...
ul {
  list-style: none;
  grid-template-columns: repeat(6, calc(100% / 6 - 8px / 6*(6 - 1)));
  row-gap: 32px;
  display: grid;
  column-gap: 8px;
